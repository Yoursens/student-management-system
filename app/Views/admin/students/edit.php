...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h5 class="mb-0" style="font-weight:600">Edit Student — <code style="color:#3b82f6"><?= esc($student['student_no']) ?></code></h5>
</div>

<div class="card" style="max-width:780px">
    <div class="card-body p-4">
        <form action="/admin/students/update/<?= $student['student_id'] ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="row g-3">
                <div class="col-md-4">
                    <label class="form-label">Student No <span class="text-danger">*</span></label>
                    <input type="text" name="student_no" class="form-control"
                        value="<?= esc(old('student_no', $student['student_no'])) ?>" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Last Name <span class="text-danger">*</span></label>
                    <input type="text" name="last_name" class="form-control"
                        value="<?= esc(old('last_name', $student['last_name'])) ?>" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">First Name <span class="text-danger">*</span></label>
                    <input type="text" name="first_name" class="form-control"
                        value="<?= esc(old('first_name', $student['first_name'])) ?>" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" name="program" class="form-control"
                        value="<?= esc(old('program', $student['program'])) ?>" required>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="section" class="form-control"
                        value="<?= esc(old('section', $student['section'])) ?>">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="contact_no" class="form-control"
                        value="<?= esc(old('contact_no', $student['contact_no'])) ?>">
                </div>
                <div class="col-12">
                    <label class="form-label">Address</label>
                    <textarea name="address" class="form-control" rows="2"><?= esc(old('address', $student['address'])) ?></textarea>
                </div>
                <div class="col-md-6">
                    <label class="form-label">New Photo <small class="text-muted">(leave blank to keep)</small></label>
